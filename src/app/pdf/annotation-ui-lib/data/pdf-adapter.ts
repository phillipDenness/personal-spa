...
export class PdfAdapter {
    ...
    setStoreData(annotationSet: AnnotationSet) {
        ...
        this.annotations.forEach((annotation: Annotation) => {
            annotation.comments.forEach((commentJson: Comment) => {
                const comment = new Comment(
                    commentJson.id,
                    commentJson.annotationId,
                    commentJson.createdBy,
                    commentJson.createdByDetails,
                    commentJson.createdDate,
                    commentJson.lastModifiedBy,
                    commentJson.lastModifiedByDetails,
                    commentJson.lastModifiedDate,
                    commentJson.content
                );
